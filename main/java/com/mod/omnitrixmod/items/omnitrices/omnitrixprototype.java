...
public class omnitrixprototype extends Item {
    ...
    public static Item INSTANCE = new omnitrixprototype(new Item.Properties().tab(ItemGroup.TAB_TOOLS).stacksTo(1).fireResistant()).setRegistryName("omnitrixprototype");
