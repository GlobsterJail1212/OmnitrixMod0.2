...
public class ultimatrix extends Item {
    public static final ResourceLocation model = new ResourceLocation("assets/models/item/ultimatrix2");
    public static Item INSTANCE = new ultimatrix(new Item.Properties().tab(ItemGroup.TAB_TOOLS).stacksTo(1).fireResistant()).setRegistryName("ultimatrix2");

    public ultimatrix(Properties properties) {
        super(properties);
    }
