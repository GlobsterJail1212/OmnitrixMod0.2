...
public class biomnitrix extends Item {
    public static final ResourceLocation model = new ResourceLocation("assets/models/item/biomnitrix");
    public static Item INSTANCE = new biomnitrix(new Properties().tab(ItemGroup.TAB_TOOLS).stacksTo(1).fireResistant()).setRegistryName("biomnitrix");

    public biomnitrix(Properties properties) {
        super(properties);
    }
    ...
    private INamedContainerProvider createContainerProvider() {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.omnitrixmod.biomnitrixgui");
            }
